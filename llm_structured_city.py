...
cultralDetails:  Liste les 2 éléments culturels les plus propres à la ville, qui peuvent être identifiés par un nom précis et représentés visuellement.
    ...
    Préfère :
        Des événements ou fêtes avec un nom propre et une date régulière,
        Des traditions artisanales uniques,
        Des spécialités culinaires précises et typiquement associées à la ville,
        Des pratiques culturelles ou rituels locaux distinctifs.
